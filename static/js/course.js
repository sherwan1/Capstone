     ...
     margin-bottom: 15px;" data-toggle="modal" data-target="#myModal"> <i class="glyphicon glyphicon-heart"></i><span> 0 </span></button>
        ...
        function check_new_post() {
                console.log("running function again");
                 ...
                 $.ajax({
                          type:"GET",
                          data: {'last_postID': postID, course_id : $("#course_id").val()},
                          url:"/course_check_new_post" , //"https://app.ticketmaster.com/discovery/v2/events/G5diZfkn0B-bh.json?apikey=27mLqO6JmMfWlES8MKnMVG1tkm75I9cE",
                          async:true,
                          dataType: "json",
                  ...
                  var course_id = $(this).attr('course_id');
                    ...
                    $.ajaxSetup({
                     ...
                     $.ajax({
                          ...
                          data: {'text': text, 'course_id' : course_id, 'send_email':send_email},
                          url:"/course_post_submit" , //"https://app.ticketmaster.com/discovery/v2/events/G5diZfkn0B-bh.json?apikey=27mLqO6JmMfWlES8MKnMVG1tkm75I9cE",
                          async:true,
                          dataType: "json",
                          success: function(json) {
